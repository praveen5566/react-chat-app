...
const MOCK_DATA_ROOM_LIST = [{ "id": 0, "name": "Tea Chats" }, { "id": 1, "name": "Coffee Chats" }];
const MOCK_DATA_ROOM_DETAIL = { "id": 1, "name": "Coffee Chats", "users": ["Jessye"] };
const MOCK_MESSAGES_BY_ROOMID = [{ "id": "ff35278", "message": "ayy", "name": "Jessye", "reaction": null }];
